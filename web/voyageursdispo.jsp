...
<!DOCTYPE html>
    ...
    <body>
      ...
      <section id="horaires" class="portfolio-section">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h4 style="color:#0CD2C6">Nos voyageurs et leur voyages</h4>
                           </div>
                    </div>
                </div>
               <div class="container">
       ...
       select v.labelVoyage, v.numtrain, c.nom,c.prenom,c.cin,r.datereserv, r.heurereserv  from client c, reservation r, voyage v where c.cin=r.cinc and v.labelVoyage=r.numvoyage ;  
             ...
             <tbody>      <tr>
                    <td><c:out value="${row.labelVoyage}"/></td>
                     ...
                     <td><c:out value="${row.cin}"/></td>
                       <td ><c:out value="${row.datereserv}"/> </td>
                    <td ><c:out value="${row.heurereserv}"/> </td>
