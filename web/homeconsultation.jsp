                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h4 style="color:#0CD2C6">Selon votre choix,consultez nos horaires disponibles</h4>
                           </div>
                    </div>
                </div>
               <div class="container">
					...
					<div class="col-md-20 col-md-offset-2 animate-box">
						<h2 class="colorlib-heading">*Nos voyages pour votre horaire</h2>
                                                <br/>
                                                <br/>
                                                <br/>
         ...
         <sql:setDataSource var="dbSource" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/ps3" user="root" password=""/>
          <sql:query dataSource="${dbSource}" var="result">
               select * from voyage
                ...
                <div class="col-md-3">
                                  <fieldset>
                                      <button type="submit" id="primary-submit" class="btn" ><a href="homenouvconsult">Faire une nouvelle consultation</a></button>
                                  </fieldset>
                </div>
                </div>
            </div>
