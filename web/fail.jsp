                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                            ...
                            <h1 style="color:#D42222"> Votre mot de passe ne correspond pas au login entré, veuillez réssayer SVP.</h1>
                          
                            <ul class="buttons">
                                <li>
                                    <div class="primary-button">
                                        <a href="#authentif">Réessayer</a>
                                    </div>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
									...
									<form action="loginservlette" method="post">
                                                                            <br/>
                                                                            <br/>
                                                                            <br/>
                                                                            <br/>
