                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="service-item first-service">
                            ...
                            <h4><div class="border-button"><a href="modifcoord.jsp">Modifier mes coordonnées</a></div></h4>
                        </div>
                    </div>
                 ...
                 <c:forEach var="row" items="${result.rows}">
                  ...
                  <td ><%=dateDepart%> </td>
                    ...
                    <td ><c:out value="${row.duree}"/> </td>
                     ...
                     <td class="action">
                        <a href="<c:url value="/choisirvoyage"><c:param name="labelVoyage" value="${ row.labelVoyage }" /></c:url>">
                            Choisir ce voyage
                        </a>
                  </tr>
