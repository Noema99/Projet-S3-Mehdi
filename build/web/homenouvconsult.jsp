...
<%@taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>                                    
        ...
        <sql:setDataSource var="dbSource" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:8080/ps3" user="root" password=""/>
        <sql:query dataSource="${dbSource}" var="result">
  select * from voyage where gareDepart=?, gareArrivee=? , dateDepart=? ;
