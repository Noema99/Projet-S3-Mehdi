        ...
        <div class="intro">
            <div class="container">
				...
				<div class="col-md-10 col-md-offset-1 col-md-pull-8 animate-box" data-animate-effect="fadeInCenter">
                                           ...
                                           <form action="modifiercoord" method="post">
						<div class="row form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                             ...
                                                             <input type="text" id="prenom" name="prenom" class="form-control" placeholder="Matricule du directeur"/>
                                                        </div>
                                                        <div class="col-md-12">
                                                             <label for="fname">Date de naissance</label>
                                                             <input type="text" id="datenaissance" name="datenaissance" class="form-control" placeholder="Date de naissance"/>
                                                        </div>
                                                    <div class="col-md-12">
                                                             <label for="fname">Télephone</label>
                                                             <input type="text" id="tel" name="tel" class="form-control" placeholder="Numéro de telephone"/>
                                                        </div>
                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                             ...
                                                             <input type="text" id="adressemail" name="adressemail" class="form-control" placeholder="Adresse Email"/>
                                                        </div>
                                                    <div class="col-md-6">
