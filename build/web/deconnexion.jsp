                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                            ...
                            <h1 style="color:#D42222">Voulez-vous vraiment vous déconnecter?.</h1>
                          
                            <ul class="buttons">
                                <li>
                                    <div class="primary-button" active>
                                        <a href="home.jsp" >Oui</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="secondary-button" disabled>
                                        <a href="espaceclient.jsp">Non</a>
                                    </div>
                                </li>
