                            ...
                            <ul class="buttons">
                                <li>
                                    <div class="primary-button">
                                        <a href="authentification.jsp">S'authentifier</a>
                                    </div>
                                </li>
                                <li>
                        ...
                        <form id="contact" action="#" method="post">
                            <div class="row">
                              ...
                              <h4> <li><i class="fa fa-user"></i> 07 07 07 07 07</li></h4>
                                                                ...
                                                                <div class="col-md-6">
                                  <fieldset>
                                    <textarea name="message" rows="6" class="form-control" id="message" placeholder="Laissez nous un commentaire..." required></textarea>
                                  </fieldset>
                                </div>
                                    <div class="col-md-12">
                                  <fieldset>
