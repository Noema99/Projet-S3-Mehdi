...
<!DOCTYPE html>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                               ...
                               <h2 style="color:#EC4426"> ESPACE SERVEUR</h2>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="service-item first-service">
                            ...
                            <h4><div class="border-button"><a href="repasdispo.jsp">Repas disponibles</a></div></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="service-item third-service">
                            ...
                            <h4><div class="border-button"><a href="commandesdispo.jsp">Liste des commandes</a></div></h4>
                    ...
                    <div class="col-md-3">
                        <div class="service-item third-service">
                            ...
                            <h4><div class="border-button"><a href="#serveurcoordonnees">Mes coordonnées</a></div></h4>
      ...
      <div class="col-lg-1">
        ...
        <section id="serveurcoordonnees" class="portfolio-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
  ...
  select * from serveur  ;
           ...
           <div class="container">
					...
					<div class="col-md-20 col-md-offset-15 animate-box">
                                                ...
                                                <h2 class="colorlib-heading" style="color:#09A34D">Modification des coordonnées</h2>
                                                <form action="modifierserveurcoord" method="post">
