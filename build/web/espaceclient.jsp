...
<!DOCTYPE html>
    ...
    <body>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                           <c:if test="${ !empty sessionScope.login && !empty sessionScope.password }">
                               <h3 style="color:#EC4426"> Vous êtes les bienvenus ${ sessionScope.login }</h3>
                             </c:if>  
                       </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-item third-service">
                            ...
                            <h4><div class="border-button"><a href="anciennereserv.jsp">Consulter mes anciennes réservations</a></div></h4>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item first-service">
                            ...
                            <h4><div class="border-button"><a href="#mescoord">Consulter mes coordonnées</a></div></h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h4 style="color:#0CD2C6">Faites vôtre choix pour réserver votre voyage !</h4>
                           </div>
                    </div>
                </div>
                		<div class="col-md-8 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
									...
									<form action="consultservletclient" method="post">
                                                                        
							<div class="row form-group">
								<div class="col-md-6">
									<label for="fname">Gare de départ</label>
									<input type="text" id="" name="" class="form-control" placeholder="...">
                                                         ...
                                                         <div class="row form-group">   
								<div class="col-md-6">
									<label for="lname">Gare d'arrivée</label>
									<input type="text" id="" name="" class="form-control" placeholder="...">
								</div>
							</div>
                                                          <div class="row form-group">
								<div class="col-md-6">
									<label for="fname">Date de voyage</label>
									<input type="text" id="" name=""  class="form-control" placeholder="...">
								</div>
     ...
     <section id="mescoord" class="portfolio-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
...
<%@taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>    
  ...
  select * from client;
                ...
                <tbody> 
                     <co:forEach var="row" items="${result.rows}">
                     <tr>
                     <td><co:out value="${row.nom}"/></td>
                     <td><co:out value="${row.prenom}"/></td>
                     <td><co:out value="${row.datenaissance}"/></td>
                     <td><co:out value="${row.tel}"/></td>
                     <td><co:out value="${row.cin}"/></td>
                     <td><co:out value="${row.addressemail}"/></td>
                     <td><co:out value="${row.login}"/></td>
                     <td><co:out value="${row.password}"/></td>
