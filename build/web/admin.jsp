                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                               ...
                               <h2 style="color:#EC4426"> ESPACE ADMINISTRATEUR</h2>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="service-item first-service">
                            ...
                            <h4><div class="border-button"><a href="voyagesdispo.jsp">Voyages disponibles</a></div></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="service-item second-service">
                            ...
                            <h4><div class="border-button"><a href="voyageursdispo.jsp">Liste des voyageurs</a></div></h4>
                    ...
                    <div class="col-md-4">
                        <div class="service-item third-service">
                            ...
                            <h4><div class="border-button"><a href="#gares">Liste des gares</a></div></h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-item third-service">
                            ...
                            <h4><div class="border-button"><a href="#admincoordonnees">Consulter mes coordonnées</a></div></h4>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item first-service">
                            ...
                            <h4><div class="border-button"><a href="espaceclientadmin.jsp">Espace clients</a></div></h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h4 style="color:#0CD2C6">Faites vôtre choix !</h4>
                           </div>
                    </div>
                </div>
					...
					<form action="consulterservletadmin" method="post">
                                                                        
					<div class="row form-group">
						<div class="col-md-6">
							<label for="fname" style="color:#0CD2C6">Gare de départ</label>
							<input type="text" id="gareDepart" name="gareDepart" class="form-control" placeholder="...">
                                                         ...
                                                         <div class="row form-group">   
								<div class="col-md-6">
									<label for="lname" style="color:#0CD2C6">Gare d'arrivée</label>
									<input type="text" id="gareArrivee" name="gareArrivee" class="form-control" placeholder="...">
								</div>
							</div>
                                                          <div class="row form-group">
								<div class="col-md-6">
									<label for="fname" style="color:#0CD2C6">Date de voyage</label>
									<input type="text" id="dateDepart" name="dateDepart"  class="form-control" placeholder="...">
								</div>
...
<%@taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>                                    
  ...
  select * from admin  ;
                ...
                <tbody> 
                     ...
                     <td><c:out value="${row.matricule}"/></td>
                     </tr>
                 </c:forEach>
                </tbody>
               </table>
         ...
         <div class="container">
					...
					<div class="col-md-20 col-md-offset-15 animate-box">
                                                ...
                                                <h1 class="colorlib-heading" style="color:#09A34D">MODIFICATION DES COORDONNEES</h1>
                                                <form action="modifieradmincoord" method="post">
							<div class="row form-group">
							<div class="col-md-6">
								...
								<div class="col-md-6">
									<label for="lname">Matricule</label>
									<input type="text" id="matricule" name="matricule" class="form-control" placeholder="..."/>
								</div>
                                                            </br>
                                                            </br>
                                                            </br>
