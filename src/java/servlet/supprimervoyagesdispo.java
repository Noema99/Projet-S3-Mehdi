 ...
 */
@WebServlet(name = "supprimervoyagesdispo", urlPatterns = {"/supprimervoyagesdispo"})
public class supprimervoyagesdispo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Voyagedb.delete(labelVoyage,numtrain);
