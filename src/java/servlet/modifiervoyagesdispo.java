 ...
 */
@WebServlet(name = "modifiervoyagesdispo", urlPatterns = {"/modifiervoyagesdispo"})
public class modifiervoyagesdispo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Voyage v = new Voyage(labelVoyage,montant,gareDepart, gareArrivee, dateDepart,dateArrivee,dateArrivee,numtrain);
            Voyagedb.modify(v);
